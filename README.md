I have got rid of all the unnecessary code so hopefully this should be enough for you to see what is going on. The my_api.rs file holds all of the code for the spi setup, transmit and read.
